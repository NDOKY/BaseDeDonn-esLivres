...
namespace BaseDeDonnéesLivres.Controllers
{
    public class LivresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,titre,auteur,anneePublication,prix")] Livre livre)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,titre,auteur,anneePublication,prix")] Livre livre)
        {
            if (id != livre.Id)
            {
                return NotFound();
